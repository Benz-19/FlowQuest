...
<body class="bg-black text-white">
    ...
    <header class="flex items-center justify-between px-8 py-6">
        <h1 class="text-3xl font-bold hover:text-gray-400 transition">FlowQuest</h1>
        <nav class="space-x-6 text-sm text-gray-300">
            <a href="#features" class="hover:underline">Features</a>
            <a href="#cards" class="hover:underline">Tools</a>
            <a href="#contact" class="hover:underline">Contact</a>
            <a href="#" class="bg-white text-black px-4 py-2 rounded hover:bg-gray-200 transition">Login</a>
        </nav>
    </header>
